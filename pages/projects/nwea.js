const project = {
    ...
    highlights: [
        'Our team works within agile scrum teams with collaborating with multiple stakeholders who love solving problems, building high quality products and services.',
        'We use a wide range of web technologies incorporating front end, automation scripting and AI/ML into our products integrating with a number of HMH created learning tools and services.',
        'Responsible for designing, implementing and supporting highly interactive, scalable and performance client-facing applications across our platform and content products',
    ],
    details:
        ...
        ' Turning ideas into code and making that code usable by your teammates and the company at scale ',

    reviews: [
        { average: 4, name: "Java-8" },
        { average: 4, name: "Spring Boot" },
        { average: 4, name: "NodeJS" },
        { average: 4, name: "React" },
        { average: 4, name: "AWS" },
        { average: 3, name: "Postgres" },
        { average: 3, name: "Jenkins" },
        { average: 3, name: "Docker" },
        { average: 3, name: "Terraform" },
        { average: 3, name: "Kraken" },
        { average: 3, name: "Kibana" },
        { average: 3, name: "Bitbucket" },
        { average: 3, name: "Target Process" },
        { average: 3, name: "Jira" },
        { average: 3, name: "Confluence" },
